...
class TrainerV1alpha1TrainingRuntimeSpec(BaseModel):
    ...
    """ # noqa: E501
    ml_policy: Optional[TrainerV1alpha1MLPolicy] = Field(default=None, alias="mlPolicy")
    pod_group_policy: Optional[TrainerV1alpha1PodGroupPolicy] = Field(default=None, alias="podGroupPolicy")
